        ...
        <div className="popup popup_type_delete-card">
          <div className="popup__container">
            ...
            <form className="popup__form" name="form-add-card" noValidate>
              <button className="popup__button-delete" type="submit" aria-label="Удалить">
                Да
              </button>
            </form>
            <button className="popup__button-close" type="button" aria-label="Закрыть окно удаления карточки">
